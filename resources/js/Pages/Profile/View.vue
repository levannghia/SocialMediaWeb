  ...
  <AuthenticatedLayout>
    <div class="max-w-[768px] mx-auto h-full overflow-auto">
      ...
      <div class="relative bg-white group">
        <img :src="coverImageSrc || user.cover_url || '/images/defaut_cover_photo.jpg'
    " alt="" class="w-full h-[200px] object-cover" />
        <div class="absolute top-2 right-2">
          ...
          <div v-else class="flex whitespace-nowrap gap-2 opacity-0 group-hover:opacity-100">
        ...
        <div class="flex">
          <div
            ...
            <img :src="avatarImageSrc || user.avatar_url || '/images/user_default.png'"
...
import { XMarkIcon, CheckIcon, CameraIcon, CheckCircleIcon, PencilIcon } from "@heroicons/vue/24/solid";
